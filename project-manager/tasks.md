...
- [x] Overhauled the application with a modern, sleek, dark neon theme for a more stylish and immersive user experience.
- [x] Added a welcome page modal for new users that explains the game mechanics, including the token system, generation costs, rarity-based resell values, and the Pokédex score.
